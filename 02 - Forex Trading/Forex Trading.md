...
- [[TWI Sniper ORB]] — Adam's own MQL5 EA (opening range breakout + FVG/demand sniper retrace), generated via SuperGrok's "Build with Grok" and maintained by Jarvis. Asset-profile system runs gold and forex off the same logic with separately scaled inputs. Compiled, backtested, and as of 2026-08-24 confirmed live-trading with two real winning trades on XAUUSD.
